...
import CmsContent from "../../html/includes/CmsContent"
		...
		<div className="container" style={{marginBottom: "50px"}}>
			...
			<div className="row">
				<div className="style-col">
					...
					<br /><br />
					<a href="" className="c-btn c-btn--small">Small button</a>
					<br /><br />
					<a href="" className="c-btn c-btn--compact">Compact button</a>
					<br /><br />
					<button className="c-btn c-btn--primary">Primary button</button>
					<br /><br />
					<a href="" className="c-btn c-btn--secondary">Secondary button</a>
				</div>
			</div>
			<div className="row">
				<div className="style-col">
			...
			<div className="row">
				<div className="style-col">
					<h1 className="heading-h0" style={{color: c.styleguideTextColor}}>CMS Content (Rich Text)</h1>
				</div>
			</div>
			<div class="row">
				<div class="style-col">
